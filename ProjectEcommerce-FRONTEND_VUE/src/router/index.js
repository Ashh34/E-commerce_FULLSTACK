...
const routes = [
  ...
  { path: '/admin/gallery', name: 'Gallery', component: Gallery },
  { path: '/admin/gallery/add', name: 'AddImage', component: AddImage },
  ...
  { path: '/category/show/:id', name: 'ListProducts', component: ListProducts },
